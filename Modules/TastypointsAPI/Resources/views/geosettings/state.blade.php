...
@section( 'page_name', "Geographic Settings - State")
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input name="state_name" class="form-control" required />
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input name="state_code" class="form-control" required />
                    </div>
                </div>
                <div class="col-md-12">
                    <div id="map">
                    ...
                    <div class="form-group">
                        <label>STATE DOTS</label>
                        <textarea name="state_dots" id="state_dots" rows="5" class="form-control"></textarea>
                    </div>
        ...
        function initialize() {
            ...
            var shapes = {
                ...
                save:function(){
                    ...
                    $("#state_dots").val(JSON.stringify(collection));
                },
    ...
    <script>
        ...
        $("#form_data").validate({
            submitHandler:function(form){
                ...
                gotForm.country_name = country[gotForm.country_id].name;
                gotForm.area_dots = [];
                try {
                    
                    let dots = JSON.parse($("#state_dots").val());
                    dots.map((item,index)=>{
        ...
        function edit(id) {
            ...
            $("#form_data input[name=state_name]").val(data.state_name);
            $("#form_data input[name=state_code]").val(data.state_code);
            ...
            $("#state_dots").val(JSON.stringify(location));
        }
