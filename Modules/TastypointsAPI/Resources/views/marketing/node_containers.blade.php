...
@section( 'page_name', "Partner Management - Node Settings Containers")
...
@section('content-header',"Node Settings Containers")
                    ...
                    <div class="col-md-5">
                        <form id="form_data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="settings_json" rows="5" class="form-control" placeholder=""></textarea>
                            </div>
                            {{-- <div class="form-group">
                            ...
                            <div>
                                <select class="pull-right" style="border: 1px solid #d2d6dd;">
                                    <option value="" disabled selected>Settings JSON Container</option>
                                </select>
                                <div class="form-group">
                                    <label>Node Settings JSON</label>
                                    <textarea name="node_settings_json" rows="5" class="form-control" placeholder=""></textarea>
                                </div>
                            </div>
                            <div class="form-group">
...
<script>
    ...
    let otable = $("#table_data").DataTable({
        ...
        "ajax": {
            ...
            "data": function(d){
                ...
                d.scr_name = "node_settings_containers";
                return d;
            },
    ...
    function FormToEditor() {
        try {
            ...
            let exclude_param = ["settings_json"];
            for(key in val){
                let value = val[key];
    ...
    $("#form_data").validate({
        submitHandler:function(form){
            ...
            console.log(gotForm);
            // gotForm.id = gotForm.id == undefined ? 0 : gotForm.id;
            // return;
            input.item_id = gotForm.id ?? 0;
            input.node_settings_containers = [gotForm];
