...
<head>
    ...
    <meta name="description" content="Login SIMTEK MELAJU - Sistem Informasi Manajemen Teknis untuk Survey SLF dan PBG Kabupaten Kubu Raya. Akses portal untuk surveyor, admin, dan pejabat.">
    <meta name="keywords" content="Login SIMTEK MELAJU, SLF Login, PBG Login, Kubu Raya, Survey Bangunan Login">
    <meta name="author" content="Dinas Pekerjaan Umum dan Penataan Ruang Kabupaten Kubu Raya">
    <meta name="robots" content="noindex, nofollow">
    
    <title>Login - SIMTEK MELAJU | Sistem Survey SLF & PBG Kubu Raya</title>
    ...
    <div class="login-container">
        ...
        <div class="login-left">
            ...
            <div class="welcome-text">
                ...
                <p>Sistem Informasi Manajemen Teknis untuk Survey SLF (Sertifikat Laik Fungsi) dan PBG (Persetujuan Bangunan Gedung) Kabupaten Kubu Raya</p>
            </div>
        </div>
