            ...
            $datatable = Datatables::of($sells)
                ->addColumn(
                    ...
                    function ($row) use ($only_shipments) {
                        ...
                        if(!empty(request()->input('is_laundry_view'))){
                            $string = '<div>';
                            ...
                            onClick="bayar(this,'
                            .$row->id.','
                            .intVal($row->final_total).')" type="button" class="btn btn-primary">Bayar</button>';
                            
                            if($row->shipping_status != "delivered")
                            $string .= '<button 
                            onClick="ambil(this,'
                            .$row->id.')" type="button" class="btn btn-success">Ambil</button>';
