...
<section class="content">
    @component('components.widget', ['class' => 'box-primary'])
        {!! Form::open(['url' => action('IngredientController@update', [$ingredient->id]), 'method' => 'put']) !!}

        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    {!! Form::label('name', 'Nama Bahan *') !!}
                    {!! Form::text('name', $ingredient->name, ['class' => 'form-control', 'required', 'placeholder' => 'Nama bahan baku']) !!}
                </div>
            </div>
            <div class="col-sm-6">
                <div class="form-group">
                    {!! Form::label('sku', 'SKU') !!}
                    {!! Form::text('sku', $ingredient->sku, ['class' => 'form-control', 'placeholder' => 'Kode bahan (opsional)']) !!}
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        {!! Form::select('unit_id', $units, $ingredient->unit_id, ['class' => 'form-control select2', 'id' => 'unit_id', 'placeholder' => 'Pilih satuan']) !!}
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <div class="checkbox">
                        <label>
                            {!! Form::checkbox('is_active', 1, $ingredient->is_active) !!} Aktif
                        </label>
                    </div>
                </div>
            </div>
