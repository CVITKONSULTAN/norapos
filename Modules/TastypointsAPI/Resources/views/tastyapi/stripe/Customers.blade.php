...
@section( 'page_name', "Customers - Stripe")
...
@section('content-header',"List Customers")
...
@section('javascript')
    ...
    <script>
                ...
                success:function(res){
                    ...
                    res.data.map((item,index)=>{
                        ...
                        <tr>
                            ...
                            <td>${item.created}</td>
                            <td>
                                <button onclick="details(${index})" class="btn btn-primary btn-xs"><i class="fas fa-eye"></i></button>
                            </td>
                        </tr>`;
        ...
        const deleteData = async (cus_id) => {
            return $.ajax({
                url:"{{ route('stripe.list',['type'=>'customers']) }}",
                method:"POST",
                data:{delete:1,customer_id:cus_id},
                success:function(res){
                    console.log(res)
                    swal("","Customer Deleted","success");
                    firstLoad();
                },
                error:function(e){
                    console.log(e)
