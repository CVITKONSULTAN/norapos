		...
		<div class="row">
			<div class="col-sm-8 col-sm-offset-2">
				<div class="form-group">
					{{-- <label>Tipe</label> --}}
					<select id="tipe" name="show_all" class="form-control">
						<option value="0">Cetak Produk Pilihan</option>
						<option value="1">Cetak Semua Produk</option>
					</select>
				</div>
				<div class="form-group">
	...
	@component('components.widget', ['class' => 'box-primary', 'title' => __( 'barcode.info_in_labels' )])
		<div class="row">
			...
			<div class="col-sm-3">
				<div class="checkbox">
				    <label>
				    	<input type="checkbox" checked name="print[barcode_show]" value="1"> <b>Barcode</b>
				    </label>
				</div>
			</div>
...
@stop
@section('javascript')
	<script src="{{ asset('js/labels.js?v=' . $asset_v.'&random='.random_int(0,999)) }}"></script>
@endsection
