      ...
      <div class="col-md-9">
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'absensi.create', false, 
                  [ 'class' => 'input-icheck']); !!} 
                    Tambah data Absensi
                </label>
              </div>
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'absensi.view', false, 
                  [ 'class' => 'input-icheck']); !!} 
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'absensi.view_all', false, 
                  [ 'class' => 'input-icheck']); !!} 
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'absensi.update', false, 
                  [ 'class' => 'input-icheck']); !!} 
                    Ubah data Absensi
                </label>
              </div>
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'absensi.delete', false, 
                  [ 'class' => 'input-icheck']); !!} 
                    Hapus data Absensi
                </label>
              </div>
        ...
        <div class="col-md-9">
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'venue_booking.view', false,
                [ 'class' => 'input-icheck']); !!}
                  Lihat booking venue
              </label>
            </div>
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'venue_booking.create', false,
                [ 'class' => 'input-icheck']); !!}
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'venue_booking.update', false,
                [ 'class' => 'input-icheck']); !!}
                  Edit booking venue
              </label>
            </div>
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'venue_booking.delete', false,
                [ 'class' => 'input-icheck']); !!}
                  Hapus booking venue
              </label>
            </div>
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'venue_booking.payment', false,
                [ 'class' => 'input-icheck']); !!}
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'venue_booking.ingredient', false,
                [ 'class' => 'input-icheck']); !!}
