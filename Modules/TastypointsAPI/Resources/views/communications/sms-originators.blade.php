...
@section( 'page_name', "Communications - SMS Originators")
...
@section('content-header',"Add SMS Originators")
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input name="originator" class="form-control" value=""/>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
...
<script>
    ...
    function edit(id) {
        ...
        $("#form_data input[name=originator]").val(data.originator);
