...
@section( 'page_name', "Partner Management - Payment Management")
...
@section('content-header',"Payment Management")
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input required name="name" class="form-control" placeholder="Add payment name" />
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    $("#form_data").validate({
        submitHandler:function(form){
            ...
            gotForm.photo = data_image.active_icon;
            gotForm.photo_selected = data_image.inactive_icon;
            input.payment_options = [gotForm];
            console.log(input);
    ...
    function edit(id) {
        ...
        // set Image
        $("#list-preview-image img").attr("src",data.photo);
        data_image.active_icon = data.photo;
        data.photo_selected = data.photo_selected == undefined ? "#" : data.photo_selected;
        $("#list-preview-image-inactive img").attr("src",data.photo_selected);
        data_image.inactive_icon = data.photo_selected;
