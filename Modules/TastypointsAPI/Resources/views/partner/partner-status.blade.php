...
@section( 'page_name', "Partner Management - Partner Status")
...
@section('content-header',"Add Partner Status")
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input name="description" class="form-control" value="" required/>
                            </div>
                        </div>
