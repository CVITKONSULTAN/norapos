...
@section( 'page_name', "Communications - Message Parameters")
...
@section('content-header',"Add Message Parameters")
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input name="parameter_name" class="form-control" value="" required/>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Parameter</label>
                                <input name="parameter" class="form-control" value="" required/>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
    ...
    <script>
        ...
        $("#form_data").validate({
            submitHandler:function(form){
                ...
                input.message_parameters = [gotForm];
        ...
        function edit(id) {
            ...
            $("#form_data input[name=parameter_name]").val(data.parameter_name);
            $("#form_data input[name=parameter]").val(data.parameter);
