                            ...
                            <table class="table table-bordered table-striped ajax_view hide-footer" id="product_table">
                                <thead>
                                    <tr>
                                        <td>ID</td>
                                        <td>Nama Siswa</td>
                                        <td>Sumatif tujuan pembelajaran</td>
                                        <td>Sumatif lingkup materi</td>
                                        <td>Nilai Sumatif akhir semester</td>
                                        <td>Nilai sumatif tujuan pembelajaran</td>
                                        <td>Nilai sumatif lingkup</td>
                                        <td>Nilai sumatif akhir semester</td>
