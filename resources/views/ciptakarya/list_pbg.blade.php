...
<section class="content">
    @component('components.widget', ['class' => 'box-primary', 'title' => ""])
        <div class="row">
            <div class="col-sm-4">
                <button class="btn btn-success btn-block btn-lg"><i class="fa fa-plus-circle" aria-hidden="true"></i> Pengajuan PBG</button>
            </div>
            <div class="col-sm-4">
                <button class="btn btn-danger btn-block btn-lg"><i class="fa fa-plus-circle" aria-hidden="true"></i> Pengajuan SLF</button>
            </div>
            <div class="col-sm-4">
                <button class="btn btn-primary btn-block btn-lg"><i class="fa fa-plus-circle" aria-hidden="true"></i> Pengajuan PBG & SLF</button>
            </div>
        </div>
    @endcomponent
