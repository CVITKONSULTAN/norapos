...
<section class="content">
    ...
    @component('components.widget', ['class' => 'box-primary', 'title' => 'Informasi Venue & Event'])
        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    {!! Form::number('estimated_guests', 0, ['class' => 'form-control', 'id' => 'estimated_guests_input', 'min' => '0']) !!}
                </div>
            </div>
            <div class="col-sm-3">
                <div class="form-group">
        ...
        <div class="row">
            <div class="col-sm-4" id="price_per_pax_row" style="display: none;">
                <div class="form-group">
                    {!! Form::label('price_per_pax', 'Harga Per Pax (Rp)') !!}
                    {!! Form::number('price_per_pax', 0, ['class' => 'form-control', 'id' => 'price_per_pax_input', 'step' => '0.01', 'min' => '0']) !!}
                </div>
            </div>
            <div class="col-sm-4">
                <div class="form-group">
                    {!! Form::label('total_amount', 'Total (Rp)') !!}
                    {!! Form::number('total_amount', 0, ['class' => 'form-control', 'id' => 'total_amount_input', 'step' => '0.01', 'min' => '0', 'placeholder' => '0']) !!}
                </div>
            </div>
        </div>
    @endcomponent
...
<script>
    $(document).ready(function() {
        ...
        // Auto-hitung total saat price_per_pax atau estimated_guests berubah
        $(document).on('input', '#price_per_pax_input, #estimated_guests_input', function() {
            calculatePerPaxTotal();
        });

        function calculatePerPaxTotal() {
            if ($('#pricing_type').val() !== 'per_pax') return;
