...
@include('sale_pos.partials.sale_table_pos_modal')
...
@section('javascript')
	...
	<script src="{{ asset('js/posV1-1.js?v=' . $asset_v) }}"></script>
	<script src="{{ asset('js/printer.js?v=' . $asset_v) }}"></script>
	<script src="{{ asset('js/product.js?v=' . $asset_v) }}"></script>
	<script src="{{ asset('js/opening_stock.js?v=' . $asset_v) }}"></script>
	@include('sale_pos.partials.keyboard_shortcuts')
	@include('sale_pos.partials.sale_table_pos')
	...
	@endif
	<script>
		$("#checkout_bayar").click(function(e){
			$('#pos-finalize').trigger('click');
		});
		$("#ambil_bayar").click(function(e){
			$('#sale_table_pos').modal('show');
		});
	</script>
@endsection