	...
	<div class="pos-form-actions">
		<div class="col-md-12">
			...
			<!-- @if(Auth::user()->business->business_category === "laundry") -->
				<button id="checkout_bayar" type="button" class="btn btn-primary @if(!$is_mobile) @endif btn-flat no-print @if($is_mobile) col-xs-6 @endif" title="Bayar"> <i class="fas fa-money-bill-alt" aria-hidden="true"></i> Checkout</button>
			<!-- @endif -->
