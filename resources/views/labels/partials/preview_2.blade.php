...
@foreach($page_products as $page_product)
	...
	@endif
		<td align="center" valign="center" @if($loop->index % 2 == 0 && $loop->index % 4 !== 0) style="padding-left:0.2in" @endif>
			<div style="overflow: hidden !important;width: 1.8in; height: 2.2in;">
				...
				{{-- Product Name --}}
				@if(!empty($print['name']))
					<div style="width:40%;margin:auto;margin-bottom:10px;">
