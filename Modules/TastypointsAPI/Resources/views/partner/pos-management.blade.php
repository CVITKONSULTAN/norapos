...
@section( 'page_name', "Partner Management - List Devices")
...
@section('content-header',"List Devices")
    ...
    <div class="main_page">
        <div class="table_container">
            <table class="table table-bordered table-striped" id="table_data">
                <thead>
                    <tr>
                        <th>POS Terminal Serial Number</th>
                        <th>Description</th>
                        <th>Action</th>
                    </tr>
                </thead>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Partner</label>
                                <select name="tpartner_id" class="form-control" required>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input name="serial_number" class="form-control" value="" required/>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
...
@section('javascript')
    <script>
        ...
        function edit(id) {
            ...
            $("#form_data input[name=serial_number]").val(data.serial_number);
                ...
                success:function(response){
                    ...
                    if(response.data){
                        ...
                        response.data.partners.map((item,index)=>{
                            ...
                            $("#form_data select[name=tpartner_id]").append(new_item);
                        });
